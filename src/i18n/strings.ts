...
const en: Record<StringKey, string> = {
  ...
  otpTooManyAttempts: "Too many tries from this phone. Please wait a few hours and try again.",
...
const hi: Record<StringKey, string> = {
  ...
  otpTooManyAttempts: "इस फ़ोन से बहुत ज़्यादा प्रयास हो गए। कुछ घंटे रुककर फिर से कोशिश करें।",
...
const kn: Record<StringKey, string> = {
  ...
  otpTooManyAttempts: "ಈ ಫೋನ್‌ನಿಂದ ತುಂಬಾ ಪ್ರಯತ್ನಗಳಾಗಿವೆ. ಕೆಲವು ಗಂಟೆಗಳ ನಂತರ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.",
...
const ta: Record<StringKey, string> = {
  ...
  otpTooManyAttempts: "இந்த ஃபோனில் இருந்து அதிக முயற்சிகள். சில மணி நேரம் கழித்து மீண்டும் முயற்சிக்கவும்.",
...
const te: Record<StringKey, string> = {
  ...
  otpTooManyAttempts: "ఈ ఫోన్ నుండి చాలా ప్రయత్నాలు జరిగాయి. కొన్ని గంటల తర్వాత మళ్లీ ప్రయత్నించండి.",
...
const ml: Record<StringKey, string> = {
  ...
  otpTooManyAttempts: "ഈ ഫോണിൽ നിന്ന് വളരെയധികം ശ്രമങ്ങൾ. കുറച്ച് മണിക്കൂറിനു ശേഷം വീണ്ടും ശ്രമിക്കുക.",
